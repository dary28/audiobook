...
IFontDisp = Font
__all__ = [ 'IFont', 'VgaColor', 'FONTUNDERSCORE', 'IFontEventsDisp',
           'Monochrome', 'OLE_XPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'OLE_HANDLE', 'FONTNAME',
           'IPictureDisp', 'OLE_COLOR', 'FONTITALIC',
           'OLE_YPOS_CONTAINER', 'StdPicture', 'FONTSIZE',
           'OLE_XPOS_HIMETRIC', 'Unchecked', 'FontEvents',
           'OLE_YSIZE_HIMETRIC', 'OLE_YSIZE_CONTAINER', 'Color',
           'OLE_YPOS_HIMETRIC', 'Default', 'OLE_CANCELBOOL',
           'StdFont', 'OLE_XPOS_CONTAINER', 'Font',
           'LoadPictureConstants', 'FONTSTRIKETHROUGH', 'Picture',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_TRISTATE', 'Checked',
           'OLE_YPOS_PIXELS', 'IPicture', 'OLE_XSIZE_CONTAINER',
           'Gray', 'IFontDisp', 'OLE_YSIZE_PIXELS',
           'OLE_XSIZE_PIXELS', 'FONTBOLD']
